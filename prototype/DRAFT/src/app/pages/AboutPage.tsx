          ...
          <div style={{ display: 'grid', gridTemplateColumns: '38% 62%', gap: '48px', alignItems: 'center' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
                {['Fashion', 'Beauty', 'Lifestyle', 'Sport', 'Business'].map((cat, i, arr) => (
            ...
            {/* RIGHT: 3-photo asymmetric grid with opacity overlays */}
            <div style={{
              display: 'grid',
              gridTemplateColumns: '1fr 1fr',
              gridTemplateRows: 'auto',
              gap: '12px',
              height: '420px', // ← ADJUST this value to change overall height
            }}>
              {/* IMG 1 — spans both rows (larger image) */}
              <div style={{ 
                overflow: 'hidden', 
                borderRadius: '4px', 
                gridRow: '1 / 3', 
              ...
              <div style={{ 
                ...
                position: 'relative', 
                backgroundColor: '#ccc',
                height: '200px', // ← ADJUST this value for individual image height
              }}>
                <img 
                  src={featImg2} 
                  alt="Feature 2"
              ...
              <div style={{ 
                ...
                position: 'relative', 
                backgroundColor: '#ccc',
                height: '208px', // ← ADJUST this value for individual image height
              }}>
                <img 
                  src={featImg3} 
                  alt="Feature 3"
