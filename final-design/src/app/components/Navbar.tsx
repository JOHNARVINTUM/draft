...
export function Navbar() {
  ...
  const isContentArea = location.pathname.startsWith('/articles');
  ...
  return (
    <>
      {/* Spacer */}
      <div style={{ height: isContentArea ? NAV_HEIGHT_WITH_CAT : NAV_HEIGHT_BASE }} />
      ...
      <header style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50 }}>
        ...
        {/* ── White category + search bar — articles, covers, magazines ── */}
        {isContentArea && (
          <div style={{
                ...
                {categories.map(cat => {
                  ...
                  return (
                    <Link
                      ...
                      className={`cat-lnk${active ? ' cat-active' : ''}`}
                      style={{
