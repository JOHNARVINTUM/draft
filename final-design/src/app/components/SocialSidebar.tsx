...
const socials = [
  { label: 'Facebook',  Icon: FacebookIcon,  href: 'https://www.facebook.com/draftmagph' },
  { label: 'Instagram', Icon: InstagramIcon, href: 'https://www.instagram.com/draftmagazine.ph/' },
  { label: 'TikTok',   Icon: TikTokIcon,    href: 'https://www.tiktok.com/@draftmagazineph' },
];
