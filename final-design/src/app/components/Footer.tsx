...
const social = [
  {
    label: "Facebook",
    handle: "@draftmagph",
    href: "https://www.facebook.com/draftmagph",
    Icon: FacebookIcon,
    bg: SOCIAL_BG,
  },
  {
    ...
    href: "https://www.instagram.com/draftmagazine.ph/",
    Icon: InstagramIcon,
    bg: SOCIAL_BG,
  },
  {
    label: "Tiktok",
    handle: "@draftmagazineph",
    href: "https://www.tiktok.com/@draftmagazineph",
    Icon: TikTokIcon,
    bg: SOCIAL_BG,
  },
];
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              {social.map(({ label, handle, href, Icon, bg }) => (
                <a
                  key={label}
                  href={href}
                  target="_blank"
