<?php
/**
 * Shared magazine navigation helpers.
 *
...
namespace Magazine_Core {
	 ...
	 * @return array
	 */
	function normalize_menu_category_links( $atts, $menu_item ) {
...
namespace {
	if ( ! function_exists( 'magazine_core_normalize_menu_category_links' ) ) {
		function magazine_core_normalize_menu_category_links( $atts, $menu_item ) {
			return \Magazine_Core\normalize_menu_category_links( $atts, $menu_item );
		}
	}
}