<?php
/**
 * Shared magazine article ACF fields.
 *
 ...
 *
 * Field names and keys are preserved from the original Parcinq theme registration
 * so existing post meta continues to resolve without migration.
 */
function register_article_hero_fields() {
...
add_action( 'acf/init', __NAMESPACE__ . '\register_article_hero_fields' );
